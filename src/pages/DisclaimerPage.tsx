          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 space-y-6">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Our services are intended for educational and research purposes only.
              </p>
            </div>
            
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Academic Integrity</h2>
              <p className="text-gray-600 leading-relaxed">
                Students should use our work as reference material and maintain academic integrity.
              </p>
            </div>
          </div>
        </div>
