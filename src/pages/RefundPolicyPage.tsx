          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 space-y-6">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                We offer a full money-back guarantee if you're not satisfied with our services.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed">
                Refunds are processed within 5-7 business days after approval of the refund request.
              </p>
            </div>
          </div>
        </div>
